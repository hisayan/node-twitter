...
var StreamClient = function(consumerKey, consumerSecret, token, tokenSecret)
{
    ...
    this._apiBaseUrlString = Constants.UserStreamApiBaseURLString;
 ...
 */
StreamClient.prototype.start = function(replies, callback)
{
    ...
    // this._createPostRequest('filter', 'json', parameters);
    this._createGetRequest('user', 'json', parameters);
